        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Document_UserProfile_CreatorGuid",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersDocument", x => new { x.DocumentsGuid, x.UsersGuid });
                    table.ForeignKey(
                        name: "FK_UsersDocument_Document_DocumentsGuid",
                        column: x => x.DocumentsGuid,
                        principalTable: "Document",
                        principalColumn: "Guid",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersDocument_UserProfile_UsersGuid",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Document_CreatorGuid",
                table: "Document",
                column: "CreatorGuid");

            migrationBuilder.CreateIndex(
                name: "IX_UsersDocument_UsersGuid",
                table: "UsersDocument",
                column: "UsersGuid");
        }
